<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeEstudiante.aspx.cs" Inherits="Enrollogic.HomeEstudiante" %>
                        ...
                        <div class="listing">
                            <div class="listing_image">
                                ...
                                <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                                    <div class="tag tag_house"><a href="carreras.aspx">house</a></div>
                                    <div class="tag tag_sale"><a href="carreras.aspx">for sale</a></div>
                                </div>
                            ...
                            <div class="listing_content">
                                <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    <a href="carrera.aspx">280 Doe Meadow Drive Landover, MD 20785</a>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="listing">
                            <div class="listing_image">
                                ...
                                <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                                    <div class="tag tag_house"><a href="carreras.aspx">house</a></div>
                                    <div class="tag tag_rent"><a href="carreras.aspx">for rent</a></div>
                                </div>
                            ...
                            <div class="listing_content">
                                <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                    <img src="images/icon_1.png" alt="">
                                    <a href="carrera.aspx">4812 Haul Road Saint Paul, MN 55102</a>
                                </div>
                                <div class="listing_info">
                                    <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        <li class="property_area d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="col-lg-4">
                        <div class="listing">
                            ...
                            <div class="listing_content">
                                <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                    <img src="images/icon_1.png" alt="">
                                    <a href="carrera.aspx">4067 Wolf Pen Road Mountain View, CA 94041</a>
                                </div>
                                <div class="listing_info">
                                    <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        <li class="property_area d-flex flex-row align-items-center justify-content-start">
