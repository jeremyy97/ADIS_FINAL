                            ...
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        ...
                                        <a href="carrera.aspx">Administración de Negocios</a>
                                    </div>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Animación y Artes Digitales<br></a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Cine y Televisión</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Contaduría</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Diseño de Interiores</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Economía Empresarial</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Educación</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Ingeniería del Sonido</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Ingeniería Electrónica</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Ingeniería Industrial</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Ingeniería Informática</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Ingeniería Química Industrial</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Odontología</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Psicología</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Publicidad</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Relaciones Internacionales</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Seguridad Laboral y Ambiental</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
                        ...
                        <div class="listing_box house sale">
                            <div class="listing">
                                ...
                                <div class="listing_content">
                                    <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                                        <img src="images/icon_1.png" alt="">
                                        <a href="carrera.aspx">Tecnologías de Información y Comunicación TIC</a>
                                    </div>
                                    <div class="listing_info">
                                        <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        </ul>
