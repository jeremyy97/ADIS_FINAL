...
namespace Enrollogic
{
    public partial class AgregarCurso : System.Web.UI.Page
    {
        ...
        {
            if (txtAula.Text != "" && txtCodigo.Text != "" && txtDescripcion.Text != "" && txtNombre.Text != "" && txtPeriodo.Text != "")
            {

                if (logica.CrearCurso(Convert.ToInt32(txtId.Text), txtCodigo.Text, txtNombre.Text, ddlCarreras.SelectedItem.Text, txtPeriodo.Text, txtDescripcion.Text, txtAula.Text, ddlProfesores.SelectedItem.Value) != null)
                {
