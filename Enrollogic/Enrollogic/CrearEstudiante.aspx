<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearEstudiante.aspx.cs" Inherits="Enrollogic.CrearUsuarios" %>
            ...
            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                ...
                <nav class="main_nav">
                    <ul class="d-flex flex-row align-items-start justify-content-start">
                        ...
                        <li class="active"><a href="CrearUsuarios.aspx">Crear Usuarios</a></li>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <asp:TextBox ID="txtCarrera"  type="text" class="form-control input-md" runat="server"></asp:TextBox>
  </div>
</div>
