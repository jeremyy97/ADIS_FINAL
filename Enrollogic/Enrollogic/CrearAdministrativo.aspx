<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearAdministrativo.aspx.cs" Inherits="Enrollogic.CrearAdministrativo" %>
            ...
            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                ...
                <nav class="main_nav">
                    <ul class="d-flex flex-row align-items-start justify-content-start">
                        ...
                        <li class="active"><a href="CrearAdministrativo.aspx">Crear Administrativo</a></li>
                    </ul>
                </nav>
...
<br /><br /><br />
<!-- Form Name -->
<legend>Crea Administrativo</legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <asp:TextBox ID="txtCargo"  type="text" class="form-control input-md" runat="server"></asp:TextBox>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
      <asp:Button ID="btnCrearAdministrativo" runat="server" Text="Crear Administrativo" class="btn btn-primary" OnClick="btnCrearAdministrativo_Click" /><br />
