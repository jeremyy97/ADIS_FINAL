<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Matricular.aspx.cs" Inherits="Enrollogic.Matricular" %>
                ...
                <table id="idTable" class="table">
                        <tr>
                            <td>
                                ...
                                <asp:TextBox ID="txtCursos" runat="server" Enabled="False" Height="384px" TextMode="MultiLine" Width="398px"></asp:TextBox></td>
                            <td>
                                <br />
                                <asp:Label ID="Label1" runat="server" Text="Ingrese el ID del curso que desea matricular:"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtCursoId" runat="server"></asp:TextBox>
                                <asp:Button class="btn btn-primary" ID="btnAgregarCurso" runat="server" Text="Agregar Curso" OnClick="btnAgregarCurso_Click" />
                                <br /><br />
                                <h5><asp:Label ID="lblMensaje" runat="server" Text="" ForeColor="Green"></asp:Label></h5>
                            </td>
                            <td>
                                <h3><span class="label label-primary">Mis cursos</span></h3>
                                <asp:TextBox ID="txtCursosMatricularS" runat="server" Enabled="False" Height="384px" TextMode="MultiLine" Width="398px"></asp:TextBox>
                                <br /><asp:Button class="btn btn-primary" ID="btnMatricual" runat="server" Text="MatricularCursos" OnClick="btnMatricual_Click" />
                            </td>
                        </tr>
                </table>
            </fieldset>
