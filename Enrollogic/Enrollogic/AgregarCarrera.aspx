<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarCarrera.aspx.cs" Inherits="Enrollogic.AgregarCarrera" %>
        ...
        <div class="super_container">
                ...
                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                    ...
                    <nav class="main_nav">
                        <ul class="d-flex flex-row align-items-start justify-content-start">
                            ...
                            <li class="active"><a href="AgregarCarrera.aspx">Agregar carrera</a></li>
            ...
            <div class="search">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="tbCarreraid">ID:</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtId" name="tbCarreraid" type="text" placeholder="Digite el ID de carrera" class="form-control input-md" runat="server"></asp:TextBox>
                    </div>
                </div>

                <!-- Text input-->
                <div class="form-group">
                    <label class="col-md-4 control-label" for="tbNombre">Nombre:</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtNombre"  name="tbNombre" type="text" placeholder="Digite el nombre de la carrera" class="form-control input-md" runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtDescripcion" name="tbDescripcion" type="text" placeholder="Digite la descripción de la carrera" class="form-control input-md" runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <asp:Button ID="btnGuardar" name="btnGuardar" class="btn btn-primary" runat="server" Text="Agregar Carrera" OnClick="btnGuardar_Click" />
