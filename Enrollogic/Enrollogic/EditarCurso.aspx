...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarCurso.aspx.cs" Inherits="Enrollogic.EditarCurso" %>
    ...
    <form id="form1" runat="server">
        <div class="super_container">
            ...
            <div class="search">
                ...
                <legend>Editar Cursos</legend>

                <table>
                    <tr>
                        <td>
                            <label for="tbCursoid">  Ingrese el ID del curso de desea editar:</label>
                        </td>
                        <td>
                            <div class="col-md-8">
                                <asp:TextBox ID="txtCursoId"  class="form-control input-md"  runat="server"></asp:TextBox>
                            </div>
                        </td>
                        <td>
                            <asp:Button ID="btnBuscar"  name="Buscar" class="btn btn-primary" runat="server" Text="Buscar Curso" OnClick="btnBuscar_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <asp:Label ID="lblBusqueda" runat="server" Text="" Font-Size="Medium" Font-Bold="True" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                </table>
                 <br />
                <asp:Label ID="Label1" runat="server" Text="____________________________________________________________________________" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#990099"></asp:Label>
                <br />
                <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="tbCursoid">ID:</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtId"  name="tbCursoid" type="text" class="form-control input-md" runat="server"  ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtCodigo"  name="tbCursoCod" type="text" class="form-control input-md" runat="server"  ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtNombre"  name="tbNombreCurso" type="text" class="form-control input-md" runat="server"  ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>

                    <!-- Select Basic -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="sbAsignarCarrera">Carrera:</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtCarrera" class="form-control" ReadOnly="True" runat="server"></asp:TextBox>   
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4"> 
                            <asp:TextBox ID="txtPeriodo" runat="server" name="tbPeriodo" type="text" class="form-control input-md"  ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtDescripcion" name="tbDescripcion" type="text"  class="form-control input-md" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtAula" name="tbAula" type="text" class="form-control input-md" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <asp:Button ID="btnGuardar" name="btnGuardar" class="btn btn-primary" runat="server" Text="Actualizar" OnClick="btnGuardar_Click" />
